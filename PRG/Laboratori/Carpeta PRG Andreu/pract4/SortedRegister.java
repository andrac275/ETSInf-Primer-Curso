...
public class SortedRegister {
    ...
    public int add(Scanner sc) {
        ...
        //De la linia 55 a la 61 era el original.
        // int count = 0;
        // while (sc.hasNext()) {    
            // count++;
        ...
        try{
            ...
            System.out.println("ERROR. Linia " + count + ": Dada no entera.");
            count = -1;
        } catch (IllegalArgumentException e) {
            System.out.println("ERROR. Linia " + count + ": " + e.getMessage());
            count = -1;
        }
    ...
    private void handleLine(String line){
        ...
        if (amount < 0) {throw new IllegalArgumentException("Quantitat negativa");}
        this.m[month][day] += amount; // Per la comprovacio anterior, no es pot produir ArrayIndexOutOfBoundsException                                       
    ...
    public int add(Scanner sc, PrintWriter err) {
        ...
        while (sc.hasNext()) {            
            ...
            err.println("ERROR. Linia " + count + ": Dada no entera.");
            //count++;
            } catch (IllegalArgumentException e) {
            err.println("ERROR. Linia " + count + ": " + e.getMessage());
            //count++;
            }
        }
